...
namespace MasterDevs.ChromeDevTools
{
    public class ChromeSession : IChromeSession
    {
        ...
        public event EventHandler<ErrorOrClosedEventArgs> ErrorOrClosed;
        ...
        {
            if (ErrorOrClosed != null) ErrorOrClosed(sender,new ErrorOrClosedEventArgs { Reason = "Closed" });
        }
        ...
        private void WebSocket_Error(object sender, SuperSocket.ClientEngine.ErrorEventArgs e)
        {
            ...
            if (ErrorOrClosed != null) ErrorOrClosed(sender, new ErrorOrClosedEventArgs { Reason = "Error" });
        }
